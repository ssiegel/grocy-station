  ...
  "/system/log-missing-localization": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["MissingLocalizationRequest"];
        };
      };
      responses: {
        /** @description The operation was successful */
    ...
    get: {
      parameters: {
        ...
        path: {
          ...
          entity:
            components["schemas"]["ExposedEntity_NotIncludingNotListable"];
        };
        cookie?: never;
      };
      requestBody?: never;
    ...
    post: {
      parameters: {
        ...
        path: {
          /** @description A valid entity name */
          entity:
            components["schemas"]["ExposedEntity_NotIncludingNotEditable"];
        };
        cookie?: never;
      };
    ...
    delete: {
      parameters: {
        ...
        path: {
          /** @description A valid entity name */
          entity:
            components["schemas"]["ExposedEntity_NotIncludingNotDeletable"];
          /** @description A valid object id of the given entity */
          objectId: number;
        };
        cookie?: never;
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["CurrentVolatilStockResponse"];
          };
        };
      };
    };
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["ExternalBarcodeLookupResponse"];
          };
        };
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["RecipeFulfillmentResponse"];
          };
        };
        /** @description The operation was not successful */
        400: {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["CurrentBatteryResponse"][];
          };
        };
        /** @description The operation was not successful (possible errors are invalid field names or conditions in filter parameters provided) */
        500: {
    ...
    post: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["BatteryChargeCycleEntry"];
          };
        };
        /** @description The operation was not successful (possible errors are: Not existing battery) */
        400: {
