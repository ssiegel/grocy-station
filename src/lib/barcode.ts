...
import { type BarcodeData, Aim, GS1, Detector } from '@point-of-sale/barcode-parser';
...
export function parseBarcode(payload: Buffer): BarcodeData {
    ...
    } else if (result.symbology === 'data-matrix' && !result.fnc1 && result.value.startsWith('grcy:')) {
